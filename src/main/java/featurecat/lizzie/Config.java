...
public class Config {
  ...
  public int kataTimeType = 0; // 0=璇荤,1=鍔犵.2=鍖呭共
  ...
  public boolean countButton = false;
  ...
  public int useLanguage = 0; // 0榛樿 1涓枃2鑻辨枃3闊╄..
  ...
  public int moveRankMarkLastMove = 1; // -1鍏抽棴 0鍏ㄩ儴
  ...
  public int foxAfterGet = 0; // 0=鏈�灏忓寲,1=鍏抽棴,2=鏃犲姩浣�
  ...
  public int tsumeGoToPlay = 1; // 1=缁ф壙,2=榛�,3=鐧�
  public int tsumeGoAttaker = 1; // 1=鑷姩妫�娴�,2=榛�,3=鐧�
  public int tsumeGoKoThreat = 1; // 1=鍙屾柟,2=杩涙敾,3=闃插畧,4=鏃�
  ...
  private boolean checkEmptyBlunderThresholds(JSONObject config) {
    ...
    boolean isDefaultTheme = theme.toLowerCase().equals("default") || theme.equals("榛樿");
  ...
  public Config() throws IOException {
    ...
    countButton = uiConfig.optBoolean("countButton", false);
  ...
  public ExtraMode getExtraMode(int value) {
    // 1=鍥涙柟鍥�2=鍙屽紩鎿�3=鎬濊�� 8=娴姩妫嬬洏妯″紡
    switch (value) {
      case 0:
