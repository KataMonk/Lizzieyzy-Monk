...
public class Menu extends JMenuBar {
  ...
  public Menu() {
    setPreferredSize(new Dimension(100, Config.menuHeight)); // 涓�25 澶�30
    // headFont = new Font(Config.sysDefaultFontName, Font.PLAIN,
    // Math.max(Lizzie.config.allFontSize, 12)); // 涓�16 澶�20
    Font baseMenuFont = new Font(Config.sysDefaultFontName, Font.PLAIN, Config.frameFontSize);
    final JFontMenu fileMenu = new JFontMenu(resourceBundle.getString("Menu.fileMenu")); // ("鏂囦欢");
    ...
    final JFontMenuItem open =
        new JFontMenuItem(resourceBundle.getString("Menu.open")); // ("鎵撳紑妫嬭氨(O)");
    ...
    final JFontMenuItem openUrl =
        new JFontMenuItem(resourceBundle.getString("Menu.openUrl")); // ("鎵撳紑鍦ㄧ嚎閾炬帴(Q)");
    ...
    final JFontMenuItem save =
        new JFontMenuItem(resourceBundle.getString("Menu.save")); // ("淇濆瓨妫嬭氨(S)");();
    ...
    final JFontMenuItem saveAs =
        new JFontMenuItem(resourceBundle.getString("Menu.saveAs")); // ("淇濆瓨妫嬭氨(S)");();
    ...
    final JFontMenu saveMore =
        new JFontMenu(
            resourceBundle.getString("Menu.saveMore")); // (); //saveMore.setText("鏇村淇濆瓨");
    fileMenu.add(saveMore);

    final JFontMenuItem saveRaw =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.saveRaw")); // ();    saveRaw.setText("淇濆瓨绾噣妫嬭氨(Crtl+Shift+S)");
    ...
    // saveCommentRaw.setText("淇濆瓨绾噣妫嬭氨(甯﹁瘎璁�)");
    ...
    // saveBranchRaw.setText("淇濆瓨绾噣鍒嗘敮(Crtl+Alt+S)");
    ...
    // saveWinrate.setText("淇濆瓨鑳滅巼鍥�(Shift+S)");
    ...
    final JFontMenuItem copyBoardScreen =
        new JFontMenuItem(
            resourceBundle.getString("Menu.copyBoardScreen")); // ("澶嶅埗涓绘鐩樺埌鍓创鏉�(Shift+C)");
    ...
    final JFontMenuItem copySubBoardScreen =
        new JFontMenuItem(
            resourceBundle.getString("Menu.copySubBoardScreen")); // ("澶嶅埗灏忔鐩樺埌鍓创鏉�(Alt+C)");
    ...
    // copySgf.setText("澶嶅埗妫嬭氨鍒板壀璐存澘(Ctrl+C)");
    ...
    // pasteSgf.setText("浠庡壀璐存澘绮樿创妫嬭氨(Ctrl+V)");
    ...
    // loadKomi.setText("鑷姩鍔犺浇妫嬭氨涓殑璐寸洰");
    ...
    final JFontMenu viewMenu = new JFontMenu(resourceBundle.getString("Menu.viewMenu")); // ("鏄剧ず");
    viewMenu.setFont(baseMenuFont);
    this.add(viewMenu);
    viewMenu.setForeground(Color.BLACK);
    // viewMenu.setFont(headFont);
    final JFontMenu panel = new JFontMenu(resourceBundle.getString("Menu.panel")); // ("闈㈡澘");
    viewMenu.add(panel);
    ...
    final JFontMenu mainBoardPos =
        new JFontMenu(resourceBundle.getString("Menu.mainBoardPos")); // ("涓绘鐩樹綅缃�");
    viewMenu.add(mainBoardPos);

    final JFontMenuItem leftMove =
        new JFontMenuItem(resourceBundle.getString("Menu.leftMove")); // ("宸︾Щ ([)");
    ...
    final JFontMenuItem rightMove =
        new JFontMenuItem(resourceBundle.getString("Menu.rightMove")); // ("鍙崇Щ (])");
    ...
    final JFontCheckBoxMenuItem coordsMenu =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.coordsMenu")); // ("鍧愭爣(C)");
    ...
    final JFontMenu moveMenu =
        new JFontMenu(resourceBundle.getString("Menu.moveMenu")); // ("鎵嬫暟(M)");
    viewMenu.add(moveMenu);

    final JFontMenu moveRankMenu =
        new JFontMenu(resourceBundle.getString("Menu.moveRankMenu")); // ("钀藉瓙璇勪环鏍囪(Alt+M)");
    viewMenu.add(moveRankMenu);
    addRankMarkMenu(null, moveRankMenu);

    final JFontMenu Suggestions =
        new JFontMenu(resourceBundle.getString("Menu.Suggestions")); // ("閫夌偣");
    viewMenu.add(Suggestions);

    final JFontMenu nextMoveHint =
        new JFontMenu(resourceBundle.getString("Menu.nextMoveHint")); // 涓嬩竴鎵�
    viewMenu.add(nextMoveHint);

    final JFontMenuItem makeAutoPlay =
        new JFontMenuItem(resourceBundle.getString("Menu.makeAutoPlay")); // ("鑷姩鎾斁(Ctrl+A)");
    ...
    final JFontCheckBoxMenuItem nextMoveHintNone =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.nextMoveHintNone")); // ("涓嶆樉绀�");
    ...
    final JFontCheckBoxMenuItem nextMoveHintSimple =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.nextMoveHintSimple")); // ("涓嶆樉绀�");
    ...
    final JFontMenuItem deletePersistFile =
        new JFontMenuItem(resourceBundle.getString("Menu.deletePersistFile")); // ("閲嶇疆鐣岄潰浣嶇疆");
    ...
    final JFontCheckBoxMenuItem noMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.noMoveNum")); // ("涓嶆樉绀�");
    ...
    final JFontCheckBoxMenuItem lastOneMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.lastOneMoveNum")); // ("鏈�杩�1鎵�");
    ...
    final JFontCheckBoxMenuItem lastFiveMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.lastFiveMoveNum")); // ("鏈�杩�5鎵�");
    ...
    final JFontCheckBoxMenuItem lastTenMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.lastTenMoveNum")); // ("鏈�杩�10鎵�");
    ...
    final JFontCheckBoxMenuItem allMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.allMoveNum")); // ("鍏ㄩ儴");
    ...
    final JFontCheckBoxMenuItem anyMoveNum =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.anyMoveNum")); // ("鑷畾涔�");
    ...
    final JFontCheckBoxMenuItem moveNumberAlwaysFromOne =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.moveNumberAlwaysFromOne")); // ("鎬绘槸浠�1寮�濮嬫樉绀�");
    ...
    final JFontCheckBoxMenuItem moveNumberInBranchFromOne =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.moveNumberInBracnhFromOne")); // ("鍒嗘敮鍐呬粠1寮�濮嬫樉绀�");
    ...
    final JFontCheckBoxMenuItem moveNumberInBranchContinue =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.moveNumberInBracnhFromOneContinue")); // ("鍒嗘敮鍐呯户缁�绘墜鏁�");
    ...
    final JFontCheckBoxMenuItem showAllMoveNumberInBranch =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showAllMoveNumberInBranch")); // ("鍒嗘敮鍐呮�绘槸鏄剧ず鎵�鏈夋墜鏁�");
    ...
    final JFontCheckBoxMenuItem showMoveNumberOnVariationPane =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showMoveNumberOnVariationPane")); // ("鏄剧ず鍒嗘敮闈㈡澘涓婄殑鎵嬫暟");
    ...
    final JFontCheckBoxMenuItem largeSubBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.largeSubBoard")); // ("鏀惧ぇ灏忔鐩�(Shift+F)");
    ...
    final JFontCheckBoxMenuItem largeWinrateGraph =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.largeWinrateGraph")); // ("鏀惧ぇ鑳滅巼鍥�(Ctrl+W)");
    ...
    final JFontCheckBoxMenuItem appendWinrateToComment =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.appendWinrateToComment")); // ("璁板綍鑳滅巼鍒拌瘎璁轰腑");
    ...
    final JFontCheckBoxMenuItem showNameInBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showNameInBoard")); // ("妫嬬洏涓嬫柟鏄剧ず榛戠櫧鍚嶅瓧");
    ...
    final JFontCheckBoxMenuItem alwaysOnTop =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.alwaysOnTop")); // ("鎬诲湪鏈�鍓�(Ctrl+Z)");
    ...
    final JFontMenu mainPanelSettings =
        new JFontMenu(resourceBundle.getString("Menu.mainPanelSettings")); // ("涓荤晫闈㈣缃�");
    ...
    final JFontCheckBoxMenuItem suggestion1 =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.winrate")); // ("鑳滅巼");
    ...
    final JFontCheckBoxMenuItem suggestion2 =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.visits")); // ("璁＄畻閲�");
    ...
    final JFontCheckBoxMenuItem suggestion3 =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.scoreLead")); // ("鐩樊");
    ...
    final JFontCheckBoxMenuItem showScoreAsDiff =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showScoreAsDiff")); // ("鐩樊");
    ...
    final JFontMenu winrate =
        new JFontMenu(resourceBundle.getString("Menu.winrateGraphSettings")); // ("鑳滅巼鍥捐缃�");
    viewMenu.add(winrate);

    final JFontCheckBoxMenuItem subboard =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.subBoard")); // ("灏忔鐩�(Z)");
    panel.add(subboard);
    ...
    final JFontCheckBoxMenuItem winrateGraph =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.winrateGraph")); // ("鑳滅巼鍥�(W)");
    ...
    final JFontCheckBoxMenuItem commitPane =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.commitPane")); // ("璇勮闈㈡澘(Alt+T)");
    ...
    final JFontCheckBoxMenuItem variationPane =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.variationPane")); // ("鍒嗘敮闈㈡澘(G)");
    ...
    final JFontCheckBoxMenuItem listPane =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.listPane")); // ("閫夌偣鍒楄〃闈㈡澘(Alt+G)");
    panel.add(listPane);
    ...
    final JFontCheckBoxMenuItem informationPane =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.informationPane")); // ("淇℃伅闈㈡澘");
    ...
    final JFontCheckBoxMenuItem statusPanel =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.statusPanel")); // ("鐘舵�侀潰鏉�");
    ...
    final JFontCheckBoxMenuItem gtpPanel =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.gtpPanel")); // ("Gtp鎺у埗鍙�(E)");
    panel.add(gtpPanel);
    ...
    final JFontCheckBoxMenuItem independentMainBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.independentMainBoard")); // ("娴姩涓绘鐩�(Alt+Q)");
    ...
    final JFontCheckBoxMenuItem independentMainBoard2 =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.independentMainBoard2")); // ("娴姩涓绘鐩�(淇濈暀鍘熸鐩�)");
    ...
    final JFontCheckBoxMenuItem independentSubBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.independentSubBoard")); // ("娴姩灏忔鐩�(Alt+W)");
    ...
    final JFontCheckBoxMenuItem hawkEye =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.hawkEye")); // ("瓒呯骇楣扮溂(T)");
    ...
    final JFontCheckBoxMenuItem SuggestionList =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.SuggestionList")); // ("鐙珛閫夌偣鍒楄〃(U)");
    ...
    final JFontCheckBoxMenuItem winrateMode0 =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.winrateMode0")); // ("榛戞柟瑙嗚");
    ...
    final JFontCheckBoxMenuItem winrateMode1 =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.winrateMode1")); // ("鍙屾柟瑙嗚");
    ...
    final JFontCheckBoxMenuItem showSuggestionOrder =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showSuggestionOrder")); // ("鏄剧ず閫夌偣鍙充笂鏂硅鏍�");
    ...
    showMaxValueReverse.setText(
        resourceBundle.getString(
            "Menu.showMaxValueReverse")); // 鏈�楂樿儨鐜�-璁＄畻閲�-鐩樊 鍙嶈壊鏄剧ず Reverse color for max value
    ...
    final JFontCheckBoxMenuItem showWhiteSuggestWhite =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.showWhiteSuggestWhite")); // 杞櫧涓嬪瓧浣撴樉绀轰负鐧借壊 Use white color for white turn
    ...
    final JFontCheckBoxMenuItem alwaysShowBlackWinrate =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.alwaysShowBlackWinrate")); // 鎬绘槸鏄剧ず榛戣儨鐜� Always show black winrate
    ...
    final JFontCheckBoxMenuItem showVariationOnMouse =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.showVariationOnMouse")); // 榧犳爣鎮仠鏄剧ず鍙樺寲鍥� Show variation on mouse over
    ...
    final JFontCheckBoxMenuItem noRefreshOnMouse =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.noRefreshOnMouse")); // 榧犳爣鎮仠鏄剧ず鍙樺寲鍥炬椂,鍙樺寲鍥句笉鍒锋柊 Variation not refresh on
    // mouse over
    ...
    final JFontMenuItem setReplayInterval =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.setReplayInterval")); // 璁剧疆閫夌偣鍙樺寲鍥惧洖鏀鹃棿闅� Set variation replay interval
    ...
    final JFontMenu subBoardSettings =
        new JFontMenu(
            resourceBundle.getString("Menu.subBoardSettings")); // 灏忔鐩樿缃� Sub board settings
    viewMenu.add(subBoardSettings);

    final JFontMenu heatMapSettings =
        new JFontMenu(resourceBundle.getString("Menu.heatMapSettings")); // Heatmap 鐑偣鍥�
    subBoardSettings.add(heatMapSettings);

    final JFontCheckBoxMenuItem subBoardShowVar =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.subBoardShowVar")); // 鍙樺寲鍥� Variation
    ...
    final JFontCheckBoxMenuItem subBoardShowRaw =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.subBoardShowRaw")); // 浠呮鐩樻瀛� Only board and stone
    ...
    final JFontCheckBoxMenuItem showHeat =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showHeat")); // Heatmap 绗竴鎰熺儹鐐瑰浘"
    ...
    final JFontCheckBoxMenuItem showHeatAfterCalc =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.showHeatAfterCalc")); // Heatmap after calculation 璁＄畻鍚庣儹鐐瑰浘
    ...
    final JFontCheckBoxMenuItem notShowHeat =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.notShowHeat")); // No heatmap 涓嶆樉绀虹儹鐐瑰浘
    ...
    final JFontMenu kataSettings =
        new JFontMenu(resourceBundle.getString("Menu.kataSettings")); // KataGo鐩稿叧璁剧疆
    viewMenu.add(kataSettings);
    viewMenu.addSeparator();

    final JFontMenuItem defaultView =
        new JFontMenuItem(
            resourceBundle.getString("Menu.defaultView")); // 榛樿妯″紡(Alt+1) Default mode (Alt+1)
    ...
    final JFontMenuItem classicView =
        new JFontMenuItem(resourceBundle.getString("Menu.classicView")); // ("缁忓吀妯″紡(Alt+2)");
    ...
    final JFontMenuItem minView =
        new JFontMenuItem(resourceBundle.getString("Menu.minView")); // ("绮剧畝妯″紡(Alt+3)");
    ...
    final JFontCheckBoxMenuItem extraMode3 =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.extraMode3")); // ("鎬濊�冩ā寮�(Alt+4)");
    ...
    final JFontCheckBoxMenuItem extraMode1 =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.extraMode1")); // ("鍥涙柟鍥炬ā寮�(Alt+5)");
    ...
    final JFontCheckBoxMenuItem extraMode2 =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.extraMode2")); // ("鍙屽紩鎿庢ā寮�(Alt+6)");
    ...
    final JFontMenu independentBoardMode =
        new JFontMenu(resourceBundle.getString("Menu.independentBoardMode")); // 娴姩妫嬬洏妯″紡
    viewMenu.add(independentBoardMode);

    final JFontMenuItem indepBothBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.indepBothBoard")); // 娴姩鍙屾鐩�(Alt+7)
    ...
    final JFontMenuItem indepMainBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.indepMainBoard")); // 娴姩涓绘鐩�
    ...
    final JFontMenuItem indepSubBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.indepSubBoard")); // 娴姩灏忔鐩�
    ...
    final JFontMenuItem indepExtraBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.indepExtraBoard")); // 棰濆娴姩妫嬬洏
    ...
    final JFontMenu kataScolreLead =
        new JFontMenu(resourceBundle.getString("Menu.kataScolreLead")); // 鐩樊鏄剧ず
    kataSettings.add(kataScolreLead);

    final JFontCheckBoxMenuItem leadWithKomi =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.leadWithKomi")); // 鐩樊
    ...
    final JFontCheckBoxMenuItem leadWithoutKomi =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.leadJustScore")); // 鐩橀潰
    ...
    //        new JFontMenu(
    //            resourceBundle.getString(
    //                "Menu.kataScoreLeadPerspective")); // 鐩樊瑙嗚 Score lead perspective
    //    kataSettings.add(kataScoreLeadPerspective);
    //
    //    final JFontCheckBoxMenuItem scoreLeadPerspectiveBlack =
    //        new JFontCheckBoxMenuItem(
    //            resourceBundle.getString("Menu.scoreLeadPerspectiveBlack")); // 姘歌繙涓洪粦瑙嗚
    ...
    //        new JFontCheckBoxMenuItem(
    //            resourceBundle.getString("Menu.scoreLeadPerspectiveAlternately")); // 榛戠櫧浜ゆ浛瑙嗚
    ...
    final JFontMenu kataEstimate =
        new JFontMenu(resourceBundle.getString("Menu.kataEstimate")); // ("Kata璇勪及鏄剧ず");
    kataSettings.add(kataEstimate);

    final JFontCheckBoxMenuItem kataEstimateClose =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.kataEstimateClose")); // ("鍏抽棴");
    ...
    final JFontCheckBoxMenuItem kataEstimateCloseView =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.kataEstimateCloseView")); // ("闅愯棌");
    ...
    final JFontCheckBoxMenuItem kataEstimateOnMainBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.kataEstimateOnMainBoard")); // ("鏄剧ず鍦ㄥぇ妫嬬洏涓�");
    ...
    final JFontCheckBoxMenuItem kataEstimateOnSubBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.kataEstimateOnSubBoard")); // ("鏄剧ず鍦ㄥ皬妫嬬洏涓�");
    ...
    final JFontCheckBoxMenuItem kataEstimateOnBothBoard =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.kataEstimateOnBothBoard")); // ("鏄剧ず鍦ㄥぇ灏忔鐩樹笂");
    ...
    final JFontCheckBoxMenuItem kataEstimateSaveState =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.kataEstimateSaveState")); // ("璁板繂Kata璇勪及鏄剧ず鐘舵��");
    ...
    final JFontCheckBoxMenuItem kataEstimateByTransparent =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.kataEstimateByTransparent")); // ("浠ユ柟鍧楅�忔槑搴﹁〃绀哄崰鏈夌巼");//Display occupancy by
    // transparent
    ...
    final JFontCheckBoxMenuItem kataEstimateByBigSquare =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.kataEstimateByBigSquare")); // ("浠ュぇ闈㈢Н鏂瑰潡琛ㄧず鍗犳湁鐜�");//Display occupancy by
    // big
    // square under stone
    ...
    final JFontCheckBoxMenuItem kataEstimateBySize =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.kataEstimateBySize")); // ("浠ユ柟鍧楀ぇ灏忚〃绀哄崰鏈夌巼");//Display occupancy by square
    // size
    ...
    final JFontCheckBoxMenuItem useKataEstimateShortcut =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.useKataEstimateShortcut")); // ("浣跨敤Kata璇勪及蹇嵎閿�(澶ч敭鐩樼偣)");
    ...
    final JFontMenu newGame = new JFontMenu(resourceBundle.getString("Menu.newGame")); // ("鏂板灞�");
    gameMenu.add(newGame);

    final JFontMenu continueGameAgainstAi =
        new JFontMenu(resourceBundle.getString("Menu.continueGameAgainstAi")); // ("浜烘満缁紙");
    gameMenu.add(continueGameAgainstAi);

    final JFontMenuItem newGenmoveGame =
        new JFontMenuItem(
            resourceBundle.getString("Menu.newGenmoveGame")); // ("浜烘満瀵瑰眬(Genmove妯″紡 Alt+N)");
    ...
    JFontMenuItem newAnalyzeModeGame = new JFontMenuItem(); // ("浜烘満瀵瑰眬(鍒嗘瀽妯″紡 N)");
    ...
    final JFontMenuItem newEngineGame =
        new JFontMenuItem(resourceBundle.getString("Menu.newEngineGame")); // ("寮曟搸瀵瑰眬(Alt+E)");
    ...
    final JFontMenuItem continueGenmoveGameAsWhite =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.continueGenmoveGameAsWhite")); // ("缁紙[AI鎵ч粦](Genmove妯″紡 Alt+鍥炶溅)");
    ...
    final JFontMenuItem continueGenmoveGameAsBlack =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.continueGenmoveGameAsBlack")); // ("缁紙[AI鎵х櫧](Genmove妯″紡 Alt+鍥炶溅)");
    ...
    final JFontMenuItem continueAnalyzeGameAsWhite =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.continueAnalyzeGameAsWhite")); // ("缁紙[AI鎵ч粦](鍒嗘瀽妯″紡 鍥炶溅)");
    ...
    continueAnalyzeGameAsBlack.setText(
        resourceBundle.getString("Menu.continueAnalyzeGameAsBlack")); // ("缁紙[AI鎵х櫧](鍒嗘瀽妯″紡 鍥炶溅)");
    ...
    final JFontCheckBoxMenuItem scoreGame =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.scoreGame")); // ("缁堝眬鏁板瓙");
    ...
    final JFontMenuItem setAiTime =
        new JFontMenuItem(resourceBundle.getString("Menu.setAiTime")); // ("淇敼AI鐢ㄦ椂");
    ...
    final JFontMenuItem breakGame =
        new JFontMenuItem(resourceBundle.getString("Menu.breakGame")); // ("缁堟浜烘満瀵瑰眬(绌烘牸)");
    ...
    final JFontMenuItem breakEngineGame =
        new JFontMenuItem(
            resourceBundle.getString("Menu.breakEngineGame")); // ("缁堟寮曟搸瀵瑰眬(ALT+R)");
    ...
    final JFontMenuItem pauseEngineGame =
        new JFontMenuItem(
            resourceBundle.getString("Menu.pauseEngineGame")); // ("鏆傚仠/缁х画寮曟搸瀵瑰眬(ALT+T)");
    ...
    final JFontMenuItem playBestMove =
        new JFontMenuItem(resourceBundle.getString("Menu.playBestMove")); // ("璁〢I钀藉瓙鏈�浣充竴鎵�(閫楀彿)");
    ...
    final JFontMenuItem playPassMove =
        new JFontMenuItem(resourceBundle.getString("Menu.playPassMove")); // ("鍋滀竴鎵�(P)");
    ...
    final JFontMenuItem togglePonder =
        new JFontMenuItem(resourceBundle.getString("Menu.togglePonder")); // ("寮�濮�/鍋滄 鍒嗘瀽(绌烘牸)");
    ...
    final JFontMenuItem hawkEye2 =
        new JFontMenuItem(resourceBundle.getString("Menu.hawkEye")); // ("瓒呯骇楣扮溂(T)");
    ...
    final JFontMenuItem autoAnalyze =
        new JFontMenuItem(resourceBundle.getString("Menu.autoAnalyze")); // ("鑷姩鍒嗘瀽(A)");
    // aboutItem.setMnemonic('A');
    ...
    final JFontMenuItem batchAnalyze =
        new JFontMenuItem(resourceBundle.getString("Menu.batchAnalyze")); // ("鎵归噺鍒嗘瀽(Ctrl+O)");
    ...
    final JFontMenuItem batchAnalysisMode =
        new JFontMenuItem(
            resourceBundle.getString("Menu.batchAnalysisMode")); // ("鎵归噺鍒嗘瀽(闂數妯″紡)");
    ...
    final JFontMenuItem stopAutoAnalyze =
        new JFontMenuItem(resourceBundle.getString("Menu.stopAutoAnalyze")); // ("鍋滄鑷姩(鎵归噺)鍒嗘瀽");
    analyzeMenu.addSeparator();
    ...
    final JFontMenuItem batchAnalyzeTable =
        new JFontMenuItem(resourceBundle.getString("Menu.batchAnalyzeTable")); // ("鎵归噺鍒嗘瀽杩涘害琛�");
    ...
    final JFontMenuItem showHeatmap =
        new JFontMenuItem(resourceBundle.getString("Menu.showHeatmap")); // ("绾綉缁�(H)");
    ...
    final JFontCheckBoxMenuItem showPolicy =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showPolicy")); // ("绛栫暐缃戠粶(Y)");
    ...
    final JFontMenuItem estimateStones =
        new JFontMenuItem(
            resourceBundle.getString("Menu.estimateStones")); // ("褰㈠娍鍒ゆ柇( / 鎴栧皬閿洏鐐�)");
    // aboutItem.setMnemonic('A');
    ...
    final JFontMenuItem clearAllLizzieCache =
        new JFontMenuItem(
            resourceBundle.getString(
                "Menu.clearAllLizzieCache")); // ("娓呴櫎Lizzie鎵�鏈夊垎鏋愮紦瀛�(Shift+A)");
    ...
    final JFontMenuItem clearThisLizzieCache =
        new JFontMenuItem(
            resourceBundle.getString("Menu.clearThisLizzieCache")); // ("娓呴櫎褰撳墠鍒嗘瀽缂撳瓨");
    ...
    final JFontMenuItem clearAllLizzieBestmoves =
        new JFontMenuItem(
            resourceBundle.getString("Menu.clearAllLizzieBestmoves")); // ("娓呴櫎鎵�鏈夊垎鏋愪俊鎭�");
    ...
    final JFontMenuItem clearThisLizzieBestmoves =
        new JFontMenuItem(
            resourceBundle.getString("Menu.clearThisLizzieBestmoves")); // ("娓呴櫎褰撳墠鍒嗘瀽淇℃伅");
    ...
    final JFontMenuItem addBlack =
        new JFontMenuItem(resourceBundle.getString("Menu.addBlack")); // ("娣诲姞榛戝瓙");
    ...
    final JFontMenuItem addWhite =
        new JFontMenuItem(resourceBundle.getString("Menu.addWhite")); // ("娣诲姞鐧藉瓙");
    ...
    final JFontMenuItem alternatelyMoves =
        new JFontMenuItem(resourceBundle.getString("Menu.alternatelyMoves")); // ("浜ゆ浛钀藉瓙");
    ...
    final JFontCheckBoxMenuItem allowDoubleClick =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.allowDoubleClick")); // ("鍏佽鍙屽嚮鎵惧瓙");
    ...
    final JFontCheckBoxMenuItem allowDrag =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.allowDrag")); // ("鍏佽鎷栧姩妫嬪瓙");
    ...
    final JFontCheckBoxMenuItem insertBlack =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.insertBlack")); // ("鎻掑叆榛戝瓙");
    ...
    final JFontCheckBoxMenuItem insertWhite =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.insertWhite")); // ("鎻掑叆鐧藉瓙");
    ...
    final JFontMenuItem clearBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.clearBoard")); // ("娓呯┖妫嬬洏(Ctrl+Home)");
    ...
    final JFontMenuItem backToMainBranch =
        new JFontMenuItem(resourceBundle.getString("Menu.backToMainBranch")); // ("杩斿洖涓诲垎鏀�(T)");
    ...
    final JFontMenuItem setAsMain =
        new JFontMenuItem(resourceBundle.getString("Menu.setAsMain")); // ("璁句负涓诲垎鏀�(L)");
    ...
    final JFontMenuItem jumpToFirst =
        new JFontMenuItem(resourceBundle.getString("Menu.jumpToFirst")); // ("璺宠浆鍒版渶鍓�(Home)");
    ...
    final JFontMenuItem jumpToLast =
        new JFontMenuItem(resourceBundle.getString("Menu.jumpToLast")); // ("璺宠浆鍒版渶鍚�(End)");
    ...
    final JFontMenuItem jumpToLeft =
        new JFontMenuItem(resourceBundle.getString("Menu.jumpToLeft")); // ("璺宠浆鍒板乏鍒嗘敮(鈫�)");
    ...
    final JFontMenuItem jumpToRight =
        new JFontMenuItem(resourceBundle.getString("Menu.jumpToRight")); // ("璺宠浆鍒板彸鍒�(鈫�)");
    ...
    final JFontMenuItem delete =
        new JFontMenuItem(resourceBundle.getString("Menu.delete")); // ("鍒犻櫎涓�鎵�(Delete)");
    editMenu.add(delete);
    ...
    final JFontMenuItem deleteBranch =
        new JFontMenuItem(
            resourceBundle.getString("Menu.deleteBranch")); // ("鍒犻櫎鍒嗘敮(Shift+Delete)");
    ...
    final JFontMenuItem setInfo =
        new JFontMenuItem(resourceBundle.getString("Menu.setInfo")); // ("缂栬緫妫嬪眬淇℃伅(I)");
    ...
    final JFontMenuItem setBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.setBoard")); // ("璁剧疆妫嬬洏澶у皬(Ctrl+I)");
    ...
    final JFontMenuItem exchange =
        new JFontMenuItem(
            resourceBundle.getString("Menu.exchange")); // ("浜ゆ崲榛戠櫧(Ctrl+Shift+Alt+鍙�)");
    ...
    final JFontMenuItem spinRight =
        new JFontMenuItem(resourceBundle.getString("Menu.spinRight")); // ("鍚戝彸鏃嬭浆(Ctrl+Alt+鍙�)");
    ...
    final JFontMenuItem spinLeft =
        new JFontMenuItem(resourceBundle.getString("Menu.spinLeft")); // ("鍚戝乏鏃嬭浆(Ctrl+Alt+宸�)");
    ...
    final JFontMenuItem mirrorVertical =
        new JFontMenuItem(
            resourceBundle.getString("Menu.mirrorVertical")); // ("姘村钩缈昏浆(Ctrl+Alt+涓�)");
    ...
    final JFontMenuItem mirrorHorizon =
        new JFontMenuItem(
            resourceBundle.getString("Menu.mirrorHorizon")); // ("鍨傜洿缈昏浆(Ctrl+Alt+涓�)");
    ...
    final JFontMenuItem shareCurrentSgf =
        new JFontMenuItem(
            resourceBundle.getString("Menu.shareCurrentSgf")); // ("鍒嗕韩褰撳墠妫嬭氨(Ctrl+E)");
    ...
    final JFontMenuItem shareBatchSgf =
        new JFontMenuItem(resourceBundle.getString("Menu.shareBatchSgf")); // ("鎵归噺鍒嗕韩");
    ...
    final JFontMenuItem shareEdit =
        new JFontMenuItem(resourceBundle.getString("Menu.shareEdit")); // ("鏌ヨ(淇敼)宸插垎浜璋变俊鎭�");
    ...
    final JFontMenuItem shareHistoryLoacl =
        new JFontMenuItem(resourceBundle.getString("Menu.shareHistoryLoacl")); // ("鍘嗗彶璁板綍(鏈湴)");
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            try {
              ...
              if (!linkHistory.exists()) {
                ...
                msg.setMessage(
                    resourceBundle.getString(
                        "Menu.shareHistoryLoaclHintEmpty")); // ("鍘嗗彶璁板綍涓虹┖");//shareHistoryLoaclHintEmpty
                // msg.setVisible(true);
                return;
              }
              ...
              msg.setMessage(
                  resourceBundle.getString(
                      "Menu.shareHistoryLoaclHintOpenFailed")); // ("鎵撳紑澶辫触");//shareHistoryLoaclHintOpenFailed
            }
          }
        });

    final JFontMenuItem shareSearch =
        new JFontMenuItem(resourceBundle.getString("Menu.shareSearch")); // ("鍏紑妫嬭氨鏌ヨ");
    ...
    final JFontMenuItem yikeLive =
        new JFontMenuItem(resourceBundle.getString("Menu.yikeLive")); // ("寮堝鐩存挱(Shift+O)");
    // live.add(yikeLive);
    final JFontMenuItem yikeRoom =
        new JFontMenuItem(resourceBundle.getString("Menu.yikeRoom")); // ("寮堝澶у巺");
    // live.add(yikeRoom);
    final JFontMenuItem foxKifu =
        new JFontMenuItem(resourceBundle.getString("Menu.foxKifu")); // ("閲庣嫄(鑵捐)妫嬭氨");
    live.add(foxKifu);
    ...
    final JFontMenuItem readBoardJava =
        new JFontMenuItem(resourceBundle.getString("Menu.readBoardJava")); // ("妫嬬洏鍚屾宸ュ叿");
    ...
    final JFontMenuItem readBoard =
        new JFontMenuItem(resourceBundle.getString("Menu.readBoard")); // ("妫嬬洏璇嗗埆宸ュ叿(Alt+O)");
    ...
    final JFontCheckBoxMenuItem EnableEnterYikeGame =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.EnableEnterYikeGame")); // //鍏佽寮堝鐩存挱/澶у巺杩涘叆瀵瑰眳瀹�
    // live.add(EnableEnterYikeGame);

    final JFontCheckBoxMenuItem alwaysGoToLastMove =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.alwaysGoToLastMove")); // //鏈夋柊鐨勪竴鎵嬫椂鎬绘槸璺宠浆鍒版渶鏂颁竴鎵�
    ...
    final JFontMenu readBoardSettings =
        new JFontMenu(resourceBundle.getString("Menu.readBoardSettings")); // ("璇嗗埆宸ュ叿閫夐」");
    live.add(readBoardSettings);

    final JFontCheckBoxMenuItem alwaysKeepBoardStatSync =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.alwaysKeepBoardStatSync")); // ("鎬绘槸淇濇寔妫嬬洏涓�鑷�(鍥為��鏃跺彲鑳界牬鍧忓巻鍙叉墜椤�)");
    ...
    final JFontCheckBoxMenuItem readBoardGetFocus =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.readBoardGetFocus")); // 婊氳疆鎺у埗鍙樺寲鍥炬椂鑷姩鑾峰彇鐒︾偣
    ...
    live.addMenuListener(
        new MenuListener() {
          ...
          public void menuSelected(MenuEvent e) {
            if (Lizzie.config.openHtmlOnLive) EnableEnterYikeGame.setState(false);
    ...
    final JMenu bottomToolBar =
        new JFontMenu(resourceBundle.getString("Menu.bottomToolBar")); // ("搴曢儴宸ュ叿鏍�");
    ...
    final JMenu detailedBar =
        new JFontMenu("璇︾粏宸ュ叿鏍�(杩囨椂鐨�)(浠呬腑鏂�)"); // ("璇︾粏宸ュ叿鏍�(杩囨椂鐨�)(浠呬腑鏂�)");
    // if (Lizzie.config.isChinese) bottomToolBar.add(detailedBar);

    final JFontCheckBoxMenuItem showDetailedBar = new JFontCheckBoxMenuItem("浣跨敤璇︾粏宸ュ叿鏍�");
    // detailedBar.add(showDetailedBar);

    final JFontCheckBoxMenuItem showDetailedMenu =
        new JFontCheckBoxMenuItem("鏄剧ず鎷撳睍/闅愯棌璇︾粏宸ュ叿鏍忔寜閽�");
    // detailedBar.add(showDetailedMenu);

    final JFontMenuItem detailedBarOrder = new JFontMenuItem("璁剧疆妯″潡椤哄簭");
    ...
    final JFontCheckBoxMenuItem showDoubleMenuBtn =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showDoubleMenuBtn")); // ("鍙屽眰鑿滃崟鎸夐挳");
    ...
    final JFontCheckBoxMenuItem showBasicBtn =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showBasicBtn")); // ("鍩烘湰鎸夐挳(浠呭弻灞傝彍鍗曟椂)");
    ...
    final JFontCheckBoxMenuItem playMoveTools =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.playMoveTools")); // ("钀藉瓙宸ュ叿");
    ...
    final JFontCheckBoxMenuItem allowAvoidTools =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.allowAvoidTools")); // ("寮哄埗璁＄畻宸ュ叿");
    ...
    final JFontCheckBoxMenuItem showGameController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showGameController")); // ("瀵瑰眬鎺у埗");
    ...
    final JFontCheckBoxMenuItem showTimeLimitController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showTimeLimitController")); // ("鍗曟鍒嗘瀽鏃堕檺(绉�)");
    ...
    final JFontCheckBoxMenuItem showPlayoutLimitController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showPlayoutLimitController")); // ("鍗曟鍒嗘瀽鏃堕檺(绉�)");
    ...
    final JFontCheckBoxMenuItem showAnalyzeController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showAnalyzeController")); // ("閫夌偣鍒嗘瀽鎺у埗");
    ...
    final JFontCheckBoxMenuItem showCandidateController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showCandidateController")); // ("閫夌偣鏄剧ず鎺у埗");
    ...
    final JFontCheckBoxMenuItem showCandidateInfoController =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("Menu.showCandidateInfoController")); // ("閫夌偣淇℃伅鎺у埗");
    ...
    final JFontCheckBoxMenuItem showRuleMenu =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showRuleMenu")); // ("瑙勫垯鎸夐挳");
    ...
    final JFontCheckBoxMenuItem showParamMenu =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showParamMenu")); // 鍙傛暟鎸夐挳
    ...
    final JFontCheckBoxMenuItem showGobanMenu =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showGobanMenu")); // ("妫嬬洏鎸夐挳");
    ...
    final JFontCheckBoxMenuItem showSaveLoadMenu =
        new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.showSaveLoadMenu")); // ("瀛樻。鎸夐挳");
    ...
    final JFontMenu customToolbarItem =
        new JFontMenu(resourceBundle.getString("Menu.customToolbar")); // ("鑷畾涔夊伐鍏锋爮鎸夐挳");
    bottomToolBar.add(customToolbarItem);

    final JFontCheckBoxMenuItem liveButton =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.liveButton")); // ("鍚屾");
    ...
    final JFontCheckBoxMenuItem shareButton =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.share")); // ("鍒嗕韩");
    ...
    final JFontCheckBoxMenuItem kataEstimateButton =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.kataEstimate")); // "Kata璇勪及");
    ...
    final JFontCheckBoxMenuItem batchOpen =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.batchOpen")); // "鎵归噺鍒嗘瀽");
    ...
    final JFontCheckBoxMenuItem openfile =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.openfile")); // "鎵撳紑");
    ...
    final JFontCheckBoxMenuItem savefile =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.savefile")); // "淇濆瓨");
    ...
    final JFontCheckBoxMenuItem countButton =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.countButton")); // "褰㈠娍鍒ゆ柇");
    // customToolbarItem.add(countButton);

    final JFontCheckBoxMenuItem finalScore =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.finalScore")); // "褰㈠娍鍒ゆ柇");
    ...
    final JFontCheckBoxMenuItem heatMap =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.heatMap")); // "绾綉缁�");
    ...
    final JFontCheckBoxMenuItem badMoves =
        new JFontCheckBoxMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.badMoves")); // "瓒呯骇楣扮溂");
    ...
    final JFontCheckBoxMenuItem analyzeList =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.analyzeList")); // "閫夌偣鍒楄〃");
    ...
    final JFontCheckBoxMenuItem refresh =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.refresh")); // "鍒锋柊");
    ...
    final JFontCheckBoxMenuItem analyse =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.analyse")); // "鍒嗘瀽");
    ...
    final JFontCheckBoxMenuItem tryPlay =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.tryPlay")); // "璇曚笅");
    ...
    final JFontCheckBoxMenuItem setMainButton =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.setMain")); // "璁句负涓诲垎鏀�");
    ...
    final JFontCheckBoxMenuItem backMain =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.backMain")); // "杩斿洖涓诲垎鏀�");
    ...
    final JFontCheckBoxMenuItem clearButton =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString("BottomToolbar.clearButton")); // "娓呯┖妫嬬洏");
    ...
    final JFontCheckBoxMenuItem deleteMove =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.deleteMove")); // "鍒犻櫎");
    ...
    final JFontCheckBoxMenuItem moveRank =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.moveRank")); // "鎵嬫暟");
    ...
    final JFontCheckBoxMenuItem move =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.move")); // "鎵嬫暟");
    ...
    final JFontCheckBoxMenuItem coords =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.coords")); // "鍧愭爣");
    ...
    final JFontCheckBoxMenuItem autoPlay =
        new JFontCheckBoxMenuItem(resourceBundle.getString("BottomToolbar.autoPlay")); // "鑷姩鎾斁");
    ...
    customToolbarItem.addMenuListener(
        new MenuListener() {
          ...
          public void menuSelected(MenuEvent e) {
            ...
            if (Lizzie.config.countButton) countButton.setState(false);
    ...
    final JFontMenuItem checkUpdate =
        new JFontMenuItem(resourceBundle.getString("Menu.checkUpdate")); // ("妫�鏌ユ洿鏂�");
    ...
    final JFontMenuItem introduction =
        new JFontMenuItem(resourceBundle.getString("Menu.introduction")); // ("绠�浠�");
    ...
    final JFontMenuItem about =
        new JFontMenuItem(resourceBundle.getString("Menu.about")); // ("鍏充簬");
    helpMenu.add(about);
    ...
    quickLinks = new JFontMenu(resourceBundle.getString("Menu.quickLinks")); // ("蹇�熷惎鍔�");
    ...
    final JFontMenuItem engineConfig =
        new JFontMenuItem(resourceBundle.getString("Menu.engineConfig")); // ("寮曟搸(Alt+X)");
    ...
    final JFontMenuItem engineRules =
        new JFontMenuItem(
            resourceBundle.getString("Menu.engineRules")); // ("瀹炴椂淇敼寮曟搸瑙勫垯(KataGo)(D)");
    ...
    final JFontMenuItem engineParameters =
        new JFontMenuItem(
            resourceBundle.getString("Menu.engineParameters")); // ("瀹炴椂淇敼寮曟搸鍙傛暟(Alt+D)");
    ...
    final JFontMenuItem initSettings =
        new JFontMenuItem(resourceBundle.getString("Menu.initSettings")); // ("鍒濆鍖栬缃�");
    ...
    final JFontMenuItem comprehensiveSettings =
        new JFontMenuItem(
            resourceBundle.getString("Menu.comprehensiveSettings")); // ("缁煎悎璁剧疆(Shift+X)");
    ...
    final JFontMenuItem theme =
        new JFontMenuItem(resourceBundle.getString("Menu.theme")); // ("涓婚");
    settings.add(theme);
    ...
    final JFontCheckBoxMenuItem languageZH = new JFontCheckBoxMenuItem("涓枃");
    ...
    final JFontCheckBoxMenuItem languageKR = new JFontCheckBoxMenuItem("頃滉淡鞏�");
    languageKR.setFont(new Font("毵戩潃 瓿犽敃", Font.PLAIN, Config.frameFontSize));
    ...
    final JFontCheckBoxMenuItem languageJP = new JFontCheckBoxMenuItem("鏃ユ湰瑾�");
    ...
    final JFontMenu frameFontSize =
        new JFontMenu(resourceBundle.getString("menu.frameFontSize")); // 鐣岄潰瀛椾綋澶у皬
    ...
    final JFontMenu frameLooks =
        new JFontMenu(resourceBundle.getString("menu.frameLooks")); // 鐣岄潰澶栬
    ...
    contributeMenu = new JFontMenu(resourceBundle.getString("Menu.contributeMenu")); // ("璺戣氨璐＄尞");
    ...
    restartCurrentEngine =
        new JFontMenuItem(resourceBundle.getString("Menu.restartCurrentEngine")); // ("閲嶅惎褰撳墠寮曟搸");
    ...
    shutdownEngine = new JFontMenu(resourceBundle.getString("Menu.shutdownEngine")); // ("鍏抽棴寮曟搸");
    engineMenu.add(shutdownEngine);

    shutdownCurrentEngine =
        new JFontMenuItem(resourceBundle.getString("Menu.shutdownCurrentEngine")); // ("鍏抽棴褰撳墠寮曟搸");
    ...
    shutdownOtherEngine =
        new JFontMenuItem(
            resourceBundle.getString("Menu.shutdownOtherEngine")); // ("鍏抽棴褰撳墠浠ュ寮曟搸");
    ...
    shutdownAllEngine =
        new JFontMenuItem(resourceBundle.getString("Menu.shutdownAllEngine")); // ("鍏抽棴鎵�鏈夊紩鎿�");
    ...
    lblKomiSpinner = new JFontLabel(resourceBundle.getString("Menu.komi")); // ("璐寸洰:");
    ...
    txtKomi.addKeyListener(
        new KeyAdapter() {
          public void keyReleased(KeyEvent e) {
            // if (e.getKeyChar() == KeyEvent.VK_ENTER) // 鎸夊洖杞﹂敭鎵ц鐩稿簲鎿嶄綔;
            // {
            try {
    ...
    lblWRN = new JFontLabel(resourceBundle.getString("Menu.lblWRN")); // ("鍒嗘瀽骞垮害鎷撳睍");
  ...
  public void updateEngineMenuone() {
    ...
    for (int i = 0; i < engineData.size(); i++) {
      ...
      if (i > (engine.length - 2)) {
        engine[i].setText(resourceBundle.getString("Menu.moreEngines")); // ("鏇村寮曟搸...");
  ...
  public void updateEngineMenuone2() {
    ...
    for (int i = 0; i < engineData.size(); i++) {
      EngineData engineDt = engineData.get(i);
      if (i > (engine.length - 2)) {
        engine2[i].setText(resourceBundle.getString("Menu.moreEngines")); // ("鏇村寮曟搸...");
  ...
  public void updateMenuAfterEngine(boolean first) {
    ...
    JFontLabel customNumberAllow =
        new JFontLabel(
            resourceBundle.getString(
                "Menu.selectLimitCustomMoves")); // "Custom limit moves:");//鑷畾涔夐檺鍒舵墜鏁�:
    ...
    JFontCheckBoxMenuItem selectAllowAllMove =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.selectLimitAllMoves")); // "Limit All moves");//闄愬埗鏁翠釜鎼滅储杩囩▼
    JFontCheckBoxMenuItem selectAllowOneMove =
        new JFontCheckBoxMenuItem(
            resourceBundle.getString(
                "Menu.selectLimitOneMove")); // ("Limit first move");//浠呴檺鍒剁涓�鎵�
    ...
    if (!Lizzie.config.showDoubleMenu) {
      ...
      JFontMenuItem analyzeGame = new JFontMenuItem(); // ("浜烘満瀵瑰眬(鍒嗘瀽妯″紡 N)");
  ...
  public void doubleMenu(boolean first) {
    ...
    if (Lizzie.config.showBasicBtn) {
      ...
      btnNewFile.setToolTipText(
          resourceBundle.getString("Menu.btnNewFile.toolTipText")); // "鎵撳紑妫嬭氨(O)");
      ...
      btnOpen.setToolTipText(resourceBundle.getString("Menu.btnOpen.toolTipText")); // "鎵撳紑妫嬭氨(O)");
      ...
      btnSave.setToolTipText(
          resourceBundle.getString("Menu.btnSave.toolTipText")); // ("淇濆瓨妫嬭氨(S)");
      ...
      JFontMenuItem flashAnalyzeAllGame =
          new JFontMenuItem(
              resourceBundle.getString("Menu.flashAnalyzeAllGame")); // "闂數鍒嗘瀽(鍏ㄥ眬)");
      flashAnalyzeAllGame.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              Lizzie.frame.flashAnalyzeGame(true, false);
      ...
      JFontMenuItem flashAnalyzePartGame =
          new JFontMenuItem(
              resourceBundle.getString("Menu.flashAnalyzePartGame")); // "闂數鍒嗘瀽(閮ㄥ垎)");
      flashAnalyzePartGame.addActionListener(
          new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
      ...
      JFontMenuItem flashAnalyzeSettings =
          new JFontMenuItem(resourceBundle.getString("Menu.flashAnalyzeSettings")); // "闂數鍒嗘瀽璁剧疆");
      flashAnalyzeSettings.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              Lizzie.frame.flashAnalyzeSettings();
      ...
      btnAnalyze.setToolTipText(
          resourceBundle.getString("Menu.btnAnalyze.toolTipText")); // ("鑷姩鍒嗘瀽(A)");
      if (Lizzie.frame.toolbarHeight > 0 && Lizzie.config.batchOpen) {
        ...
        final JFontMenuItem stopAutoAnalyze =
            new JFontMenuItem(
                resourceBundle.getString("Menu.stopAutoAnalyze")); // ("鍋滄鑷姩(鎵归噺)鍒嗘瀽");
        ...
        final JFontMenuItem batchAnalyzeTable =
            new JFontMenuItem(
                resourceBundle.getString("Menu.batchAnalyzeTable")); // ("鎵归噺鍒嗘瀽杩涘害琛�");
      ...
      btnHawkeye.setToolTipText(
          resourceBundle.getString("Menu.btnHawkeye.toolTipText")); // ("鑷姩鍒嗘瀽(A)");
      ...
      btnRankMark.setToolTipText(
          resourceBundle.getString("Menu.btnRankMark.toolTipText")); // ("鑷姩鍒嗘瀽(A)");
      ...
      btnSetMain.setToolTipText(
          resourceBundle.getString("Menu.btnSetMain.toolTipText")); // ("璁句负涓诲垎鏀�(L)");
      ...
      btnBackMain.setToolTipText(
          resourceBundle.getString("Menu.btnBackMain.toolTipText")); // ("杩斿洖涓诲垎鏀�(T)");
      ...
      btnChangeTurn.setToolTipText(
          resourceBundle.getString("Menu.btnChangeTurn.toolTipText")); // ("璁句负涓诲垎鏀�(L)");
      ...
      btnMarkup.setToolTipText(
          resourceBundle.getString("Menu.btnMarkup.toolTipText")); // "鏍囪宸ュ叿");
      ...
      btnMarkupClear.setToolTipText(
          resourceBundle.getString("Menu.btnMarkupClear.toolTipText")); // ("娓呴櫎");
    ...
    JFontLabel lblAnalyzeGame =
        new JFontLabel(
            resourceBundle.getString(
                "Menu.newAnalyzeModeGame")); // "Custom limit moves:");//鑷畾涔夐檺鍒舵墜鏁�:
    setToolTipJMenu(analyzeGame, lblAnalyzeGame);
    lblAnalyzeGame.setBounds(
        Lizzie.config.useJavaLooks ? 6 : 37,
        (Lizzie.config.useJavaLooks
  ...
  private void addRankMarkMenu(JPopupMenu rankPopupMenu, JMenu rankJMenu) {
    ...
    chkUseWinScore.add(new JFontLabel(resourceBundle.getString("Menu.rankMenu.base"))); // 渚濇嵁:
  ...
  private void setKomiPanelInDoubleMenu() {
    ...
    if (Lizzie.config.showTimeControlInMenu || Lizzie.config.showPlayoutControlInMenu) {
      ...
      Lizzie.frame.topPanel.add(
          new JFontLabel(resourceBundle.getString("Menu.lblLimit"))); // "闄愬埗:"));
        ...
        new Thread() {
          public void run() {
            ...
            if (Lizzie.config.showTimeControlInMenu || Lizzie.config.showPlayoutControlInMenu) {
              ...
              toolPanel.add(new JFontLabel(resourceBundle.getString("Menu.lblLimit"))); // "闄愬埗:"));
              if (Lizzie.config.showTimeControlInMenu) {
  ...
  public void updateFastLinks() {
    ...
    JFontMenuItem editProgram =
        new JFontMenuItem(resourceBundle.getString("Menu.editProgram")); // "璁剧疆");
