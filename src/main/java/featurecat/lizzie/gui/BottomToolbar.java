...
public class BottomToolbar extends JPanel {
  ...
  public boolean showDetail = Lizzie.config.showDetailedToolbarMenu && false;
  JButton firstButton;
  JButton lastButton;
  JButton clearButton;
  JButton countButton;
  ...
  public BottomToolbar() {
    ...
    rightMove = new JButton("銆�");
    leftMove = new JButton("銆�");
    deleteMove =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.deleteMove")); // ("鍒犻櫎");
    badMoves =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.badMoves")); // ("瓒呯骇楣扮溂");
    share = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.share")); // ("鍒嗕韩");
    flashAnalyze = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.flashAnalyze"));
    liveButton =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.liveButton")); // ("鐩存挱");
    clearButton =
        new JFontButton(
            Lizzie.resourceBundle.getString("BottomToolbar.clearButton")); // ("娓呯┖妫嬬洏");
    firstButton = new JFontButton("|<");
    lastButton = new JFontButton(">|");
    countButton =
        new JFontButton(
            Lizzie.resourceBundle.getString("BottomToolbar.countButton")); // ("褰㈠娍鍒ゆ柇");
    finalScore =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.finalScore")); // ("缁堝眬鏁板瓙");
    forward10 = new JFontButton(">>");
    backward10 = new JFontButton("<<");
    gotomove =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.gotomove")); // ("璺宠浆");
    savefile =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.savefile")); // ("淇濆瓨");
    backward1 = new JFontButton("<");
    forward1 = new JFontButton(">");
    openfile =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.openfile")); // ("鎵撳紑");
    kataEstimate =
        new JFontButton(
            Lizzie.resourceBundle.getString("BottomToolbar.kataEstimate")); // ("Kata璇勪及");
    analyse = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.analyse")); // ("鍒嗘瀽");
    heatMap =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.heatMap")); // ("绾綉缁�");
    backMain =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.backMain")); // ("杩斿洖涓诲垎鏀�");
    setMain =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.setMain")); // ("璁句负涓诲垎鏀�");
    batchOpen =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.batchOpen")); // ("鎵归噺鍒嗘瀽");
    refresh = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.refresh")); // ("鍒锋柊");
    tryPlay = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.tryPlay")); // ("璇曚笅");
    analyzeList =
        new JFontButton(
            Lizzie.resourceBundle.getString("BottomToolbar.analyzeList")); // ("閫夌偣鍒楄〃");
    move = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.move")); // ("鎵嬫暟");
    moveRank = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.moveRank"));
    coords = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.coords")); // ("鍧愭爣");
    autoPlay =
        new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.autoPlay")); // ("鑷姩鎾斁");
    ...
    JFontMenuItem shareCurSgf =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.shareCurSgf")); // ("鍒嗕韩褰撳墠妫嬭氨");
    ...
    JFontMenuItem shareBatchSgf =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.shareBatchSgf")); // ("鍒嗕韩褰撳墠妫嬭氨");
    ...
    //        new JMenuItem(
    //            Lizzie.resourceBundle.getString("BottomToolbar.shareHistory")); //
    // ("鍘嗗彶璁板綍(鏈湴)");
    ...
    JFontMenuItem editHistoryRemote =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString(
                "BottomToolbar.editHistoryRemote")); // ("鏌ヨ(淇敼)宸插垎浜璋变俊鎭�");
    ...
    JFontMenuItem shareHistoryRemote =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.shareHistoryRemote")); // ("鍏紑妫嬭氨鏌ヨ");
    ...
    JFontMenuItem yikeLive =
        new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.yikeLive")); // ("寮堝鐩存挱");
    ...
    JFontMenuItem yikeRoom =
        new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.yikeRoom")); // ("寮堝澶у巺");
    ...
    JFontMenuItem foxKifu =
        new JFontMenuItem(Lizzie.resourceBundle.getString("Menu.foxKifu")); // ("閲庣嫄");
    ...
    JFontMenuItem syncBoardJava =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.syncBoardJava")); // ("妫嬬洏鍚屾");
    ...
    JFontMenuItem syncBoard =
        new JFontMenuItem(
            Lizzie.resourceBundle.getString("BottomToolbar.syncBoard")); // ("妫嬬洏鍚屾");
    ...
    lblchkAutoAnalyse = new JLabel("鑷姩鍒嗘瀽");
    ...
    chkAnaBlack = new JCheckBox("榛�");
    chkAnaWhite = new JCheckBox("鐧�");
    ...
    lblAnaFirstPlayouts = new JLabel("棣栦綅璁＄畻閲�:");
    ...
    JButton stopGo = new JButton("鏆傚仠");
    stopGo.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Lizzie.leelaz.togglePonder();
            if (Lizzie.leelaz.isPondering()) stopGo.setText("鏆傚仠");
            else stopGo.setText("缁х画");
          }
        });
    ...
    lblAnaAutoSave = new JLabel("淇濆瓨妫嬭氨");
    ...
    lbltxtAnaPlayouts = new JLabel("鎬昏绠楅噺:");
    ...
    lbltxtAnaTime = new JLabel("鎸夋椂闂�(绉�):");
    ...
    JButton analysisTable = new JButton("鎵归噺杩涘害琛�");
    ...
    lblchkShowBlack = new JLabel("鏄剧ず榛�");
    lblchkShowWhite = new JLabel("鏄剧ず鐧�");

    JLabel autoMain = new JLabel("鑷姩鎾斁(澶�)(绉�)");
    JLabel autoSub = new JLabel("鑷姩鍙樺寲鍥�(姣)");
    ...
    lblAutoPlayBlack = new JLabel("榛�");
    lblAutoPlayWhite = new JLabel("鐧�");
    ...
    lblAutoPlayPlayouts = new JLabel("鎬昏绠楅噺:");
    ...
    lblAutoPlayFirstPlayouts = new JLabel("棣栦綅璁＄畻閲�:");
    ...
    btnEnginePkConfig = new JButton("璁剧疆");
    ...
    btnEnginePkStop = new JButton("鏆傚仠");
            ...
            if (isGenmoveToolbar) {
              if (isPkStop) {
                if (!isPkGenmoveStop) {
                  ...
                  //                  Message msg = new Message();
                  //                  msg.setMessage("Genmove妯″紡涓嬫殏鍋滃悗椤荤瓑寰呮渶鍚庝竴姝ヨ惤瀛愬畬鎴�");
                  //                  msg.setVisible(true);
                  return;
                }
                btnEnginePkStop.setText("鏆傚仠");
                isPkStop = false;
                if (isPkStopGenmoveB) {
    ...
    lblenginePkTime = new JLabel("鏃堕棿(绉�) 榛�");
    lblenginePkTimeWhite = new JLabel("鐧�");
    ...
    btnStartPk.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            //                msg = new Message();
            //                msg.setMessage("璇峰厛鍕鹃�塠寮曟搸瀵规垬],骞堕�夋嫨榛戠櫧寮曟搸鍚庡啀寮�濮�");
            //                msg.setVisible(true);
            //              }
            //              Lizzie.frame.addInput();
            //              return;
    ...
    lblenginePkFirstPlayputs = new JLabel("棣栦綅璁＄畻閲�  榛�:");
    ...
    lblenginePkFirstPlayputsWhite = new JLabel("鐧�:");
    ...
    lblenginePkBatch = new JLabel("澶氱洏:");
    ...
    lblenginePkExchange = new JLabel("缁紙");
    ...
    chkenginePkContinue.setToolTipText("鍏堟憜濂戒竴涓眬闈�,鐒跺悗鍕鹃�夊氨鍙互姣忕洏閮戒粠杩欎釜灞�闈㈠紑濮嬪鎴�");
    ...
    lblenginePkPlayputs = new JLabel("鎬昏绠楅噺  榛�:");
    ...
    lblenginePkPlayputsWhite = new JLabel("鐧�:");
    ...
    btnEngineMannul = new JButton("骞查");
    ...
    // lblenginePkAutosave = new JLabel("鑷姩淇濆瓨");
  ...
  public void resetAutoAna() {
    chkAnaBlack.setText("榛�");
    chkAnaWhite.setText("鐧�");
    txtFirstAnaMove.setBounds(138, 2, 30, 18);
    txtLastAnaMove.setBounds(185, 2, 30, 18);
  ...
  //        passandMove = passandMove + "鍙屾柟Pass灞�鏁� " + doublePassGame;
  //      if (Lizzie.frame.toolbar.maxMoveGame > 0)
  //        passandMove = passandMove + "瓒呮渶澶ф墜鏁板眬鏁�  " + maxMoveGame;
  //      msg.setMessage(
  //          "鎵归噺瀵规垬宸茬粨鏉�,姣斿垎涓篬"
  ...
  public void enableDisabelForEngineGame(boolean enable) {
    if (!enable) btnStartPk.setText("缁堟");
    else btnStartPk.setText("寮�濮�");
    btnEnginePkStop.setText("鏆傚仠");
  ...
  ////        onTop = true;
  ////      }
  ////      JOptionPane.showMessageDialog(null, "榛戠櫧蹇呴』涓轰笉鍚屽紩鎿�");
  ////      if (onTop) Lizzie.frame.setAlwaysOnTop(true);
  //    	Utils.showMsg("榛戠櫧涓嶈兘閫夋嫨鐩稿悓寮曟搸");
  //      Lizzie.frame.addInput();
  //      return;
  //      //    }
  //      //   isSameEngine = true;
  ...
  //    pkWhiteWins = 0;
  //
  //    featurecat.lizzie.gui.Menu.engineMenu.setText("瀵规垬涓�");
  ...
  private void setButtonVisiable() {
    ...
    if (Lizzie.config.countButton) countButton.setVisible(false);
