...
public class ConfigDialog2 extends JDialog {
  ...
  public ConfigDialog2() {
    ...
    JLabel lblAlwaysOnTop =
        new JLabel(resourceBundle.getString("LizzieConfig.lblAlwaysOnTop")); // ("绐楀彛鎬诲湪鏈�鍓�");
    ...
    JLabel lblShowQuickLinks =
        new JLabel(resourceBundle.getString("LizzieConfig.lblShowQuickLinks")); // ("鏄剧ず蹇�熷惎鍔�");
    ...
    JLabel lblShowStatus =
        new JLabel(resourceBundle.getString("LizzieConfig.lblShowStatus")); // ("鏄剧ず鐘舵�侀潰鏉�");
    ...
    JLabel lblShowAllMove =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowAllMove")); // ("鍒嗘敮鍐呮�绘槸鏄剧ず鎵嬫暟"); // $NON-NLS-1$
    ...
    JLabel lblWinratePerspective =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblWinratePerspective")); // ("鑳滅巼鍥捐瑙�"); //$NON-NLS-1$
    lblWinratePerspective.setBounds(10, 236, 184, 16);
    uiTab.add(lblWinratePerspective);

    rdoShowWinrateBlack =
        new JRadioButton(
            resourceBundle.getString("LizzieConfig.rdoShowWinrateBlack")); // ("榛戞柟瑙嗚");
    rdoShowWinrateBlack.setBounds(Lizzie.config.isChinese ? 155 : 162, 234, 60, 23);
    uiTab.add(rdoShowWinrateBlack);

    rdoShowWinrateBoth =
        new JRadioButton(
            resourceBundle.getString("LizzieConfig.rdoShowWinrateBoth")); // ("鍙屾柟瑙嗚");
    ...
    JLabel lblShowWhiteSuggestionWhite =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowWhiteSuggestionWhite")); // ("杞櫧涓嬮�夌偣瀛椾綋鐧借壊");
    ...
    chkShowWhiteSuggWhite.addItem(
        resourceBundle.getString("LizzieConfig.chkShowWhiteSuggWhite1")); // ("鏃�");
    chkShowWhiteSuggWhite.addItem(
        resourceBundle.getString("LizzieConfig.chkShowWhiteSuggWhite2")); // ("浠呴�夌偣");
    chkShowWhiteSuggWhite.addItem(
        resourceBundle.getString("LizzieConfig.chkShowWhiteSuggWhite3")); // ("浠呰鏍�");
    chkShowWhiteSuggWhite.addItem(
        resourceBundle.getString("LizzieConfig.chkShowWhiteSuggWhite4")); // ("鍏ㄩ儴");
    ...
    JLabel lblSuggestionMoveColorConcentration =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblSuggestionMoveColorConcentration")); // ("閫夌偣棰滆壊闆嗕腑绋嬪害");
    ...
    SuggestionColorRatio.addItem(
        resourceBundle.getString("LizzieConfig.SuggestionMoveColorConcentration1")); // ("闆嗕腑");
    SuggestionColorRatio.addItem(
        resourceBundle.getString("LizzieConfig.SuggestionMoveColorConcentration2")); // ("涓�鑸�");
    SuggestionColorRatio.addItem(
        resourceBundle.getString("LizzieConfig.SuggestionMoveColorConcentration3")); // ("鍒嗘暎");
    ...
    JLabel lblAppendWinrateToComment =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblAppendWinrateToComment")); // ("璁板綍鑳滅巼鍒拌瘎璁轰腑");
    ...
    JLabel lblShowSuggestionMoveOrder =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowSuggestionMoveOrder")); // ("鏄剧ず閫夌偣鍙充笂鏂硅鏍�");
    ...
    JLabel lblMaxValueReverseColor =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblMaxValueReverseColor")); // ("鏈�楂樿儨鐜囪绠楅噺鍙嶈壊鏄剧ず"); // $NON-NLS-1$
    ...
    JLabel lblShowVariationsOnMouse =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowVariationsOnMouse")); // ("榧犳爣鎮仠鏄剧ず鍙樺寲鍥�");
    ...
    JLabel lblNotRereshVairationsOnMouseOver =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblNotRereshVairationsOnMouseOver")); // ("榧犳爣鎮仠鏃� 鍙樺寲鍥句笉鍒锋柊");
    ...
    JLabel lblBoardPositionProportion =
        new JLabel(
            resourceBundle.getString("LizzieConfig.lblBoardPositionProportion")); // ("涓荤晫闈㈠亸绉�");
    ...
    JLabel showBlueRing =
        new JLabel(resourceBundle.getString("LizzieConfig.showBlueRing")); // ("绗竴閫夌偣涓婃樉绀鸿摑鍦�");
    ...
    JLabel showNameInboard =
        new JLabel(
            resourceBundle.getString("LizzieConfig.showNameInboard")); // "鍦ㄦ鐩樹笅鏂规樉绀洪粦鐧藉悕瀛�");
    ...
    JLabel lblAlwaysShowBlackWinrate =
        new JLabel(
            resourceBundle.getString("LizzieConfig.lblAlwaysShowBlackWinrate")); // ("鎬绘槸鏄剧ず榛戣儨鐜�");
    ...
    JLabel lblShowCircleForOutOfLimit =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowCircleForOutOfLimit")); // ("瓒呴檺鍒�(浣庤绠�)閫夌偣渚濈劧鏄剧ず鎺ㄨ崘鍦�");
    ...
    JLabel lblViewSettings =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblViewSettings")); // ("鐣岄潰闈㈡澘閫夐」:"); // $NON-NLS-1$
    ...
    JLabel lblSuggestionMoveAndWinrateSettings =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblSuggestionMoveAndWinrateSettings")); // ("閫夌偣涓庤儨鐜囧浘閫夐」:"); //
    // $NON-NLS-1$
    ...
    JLabel lblOtherSettings =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblEngineSettings")); // ("鍏朵粬閫夐」:"); // $NON-NLS-1$
    ...
    JLabel lblEngineSettings =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblOtherSettings")); // ("寮曟搸閫夐」:"); // $NON-NLS-1$
    ...
    JLabel lblMaxAnalyzeTime =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.title.maxAnalyzeTime")); // ("鏈�澶у垎鏋愭椂闂�"); // $NON-NLS-1$
    ...
    JLabel lblManAiGameTime =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.title.lblManAiGameTime")); // ("浜烘満瀵瑰眬AI姣忔墜鐢ㄦ椂"); // $NON-NLS-1$
    ...
    JLabel lblAnalyzeUpdateInterval =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.title.analyzeUpdateInterval")); // ("鍒嗘瀽缁撴灉鍒锋柊鏃堕棿");
    ...
    JLabel lblSsh =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.title.SSHanalyzeUpdateInterval")); // ("SSH鍒嗘瀽缁撴灉鍒锋柊鏃堕棿");
    ...
    JLabel lblEngineFastSwitch =
        new JLabel(
            resourceBundle.getString("ConfigDialog2.lblEngineFastSwitch")); // ("鏄惁鍚敤寮曟搸蹇�熷垏鎹�");
    ...
    JLabel lblMouseMoveRect =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblMouseMoveRect")); // ("榧犳爣绉诲姩鏃舵樉绀哄皬鏂瑰潡"); // $NON-NLS-1$
    lblMouseMoveRect.setBounds(10, 580, 184, 16);
    uiTab.add(lblMouseMoveRect);

    rdoShowMoveRect =
        new JRadioButton(resourceBundle.getString("LizzieConfig.rdoShowMoveRect")); // ("鏄�");
    rdoShowMoveRect.setBounds(200, 577, 50, 23);
    uiTab.add(rdoShowMoveRect);

    rdoShowMoveRectOnPlay =
        new JRadioButton(
            resourceBundle.getString("LizzieConfig.rdoShowMoveRectOnPlay")); // ("浠呭灞�鏃�");
    rdoShowMoveRectOnPlay.setBounds(273, 577, 105, 23);
    uiTab.add(rdoShowMoveRectOnPlay);

    rdoNoShowMoveRect =
        new JRadioButton(resourceBundle.getString("LizzieConfig.rdoNoShowMoveRect")); // ("鍚�");
    ...
    JLabel lblBackgroundPonder =
        new JLabel(
            resourceBundle.getString("ConfigDialog2.lblBackgroundPonder")); // ("瀵瑰紙鏃禔I鏄惁鍚庡彴璁＄畻");
    ...
    JLabel lblNoticeLimit =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblNoticeLimit")); // ("娉�: 0浠ｈ〃鏃犻檺鍒�"); // $NON-NLS-1$
    ...
    lblShowTitleWinInfo =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowTitleWinInfo")); // "鏍囬涓婃樉绀鸿儨鐜囩瓑淇℃伅"); // $NON-NLS-1$
    ...
    JLabel lblAlwaysLogGtpInfo =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblAlwaysLogGtpInfo")); // ("鎬绘槸璁板綍GTP淇℃伅"); // $NON-NLS-1$
    ...
    JLabel lblGomoku = new JLabel(resourceBundle.getString("ConfigDialog2.lblGomoku")); // "浜斿瓙妫�");
    ...
    JLabel lblSubBoardNotRefreshOnMouseOver =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblSubBoardNotRefreshOnMouseOver")); // ("榧犳爣鎮仠鍦ㄥ皬妫嬬洏涓婃椂涓嶅埛鏂�");
    // $NON-NLS-1$
    ...
    JLabel lblEnableDoubleClickFindMove =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblEnableDoubleClickFindMove")); // ("鍚敤鍙屽嚮鎵惧瓙");
    ...
    JLabel lblEnableDragStone =
        new JLabel(
            resourceBundle.getString("LizzieConfig.lblEnableDragStone")); // ("鍚敤鎷栨嫿妫嬪瓙鍔熻兘");
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            lizzieCacheDiscribe.setInfo(
                ...
                // "鍥為��灞�闈㈡椂,鏈夋椂鍊欏紩鎿庡凡缁忛仐蹇樹簡涔嬪墠鐨勮绠楃粨鏋滀細浠�0璁＄畻銆傚鍚敤Lizzie缂撳瓨,鍒欑晫闈笂渚濈劧鏄剧ず涔嬪墠鐨勮绠楃粨鏋�,鐩村埌鏂扮殑璁＄畻缁撴灉鎬昏绠楅噺瓒呰繃浠ュ墠鐨勭粨绠楃粨鏋滀负姝€��",
                resourceBundle.getString("LizzieConfig.aboutLizzieCacheTitle"),
                Lizzie.frame.configDialog2); //  "Lizzie缂撳瓨璇存槑");
          }
        });
    uiTab.add(btnLizzieCache);

    JLabel lblRightClickFunction =
        new JLabel(resourceBundle.getString("LizzieConfig.lblRightClickFunction")); // "榧犳爣鍙抽敭鍔熻兘");
    ...
    rdoRightClickMenu =
        new JRadioButton(
            resourceBundle.getString(
                "LizzieConfig.rdoRightClickMenu")); // ("寮瑰嚭鑿滃崟"); // $NON-NLS-1$
    rdoRightClickMenu.setBounds(145, 667, 73, 23);

    rdoRightClickBack =
        new JRadioButton(
            resourceBundle.getString(
                "LizzieConfig.rdoRightClickBack")); // ("鍥為��涓�鎵�"); // $NON-NLS-1$
    ...
    JLabel lblMoveNumInBracnh =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblMoveNumInBracnh")); // ("鍒嗘敮鍐呮墜鏁�"); // $NON-NLS-1$
    ...
    rdoBranchMoveOne =
        new JRadioButton(
            resourceBundle.getString(
                "LizzieConfig.rdoBranchMoveOne")); // ("浠�1寮�濮�"); // $NON-NLS-1$
    ...
    rdoBranchMoveContinue =
        new JRadioButton(
            resourceBundle.getString(
                "LizzieConfig.rdoBranchMoveContinue")); // ("缁х画"); // $NON-NLS-1$
    ...
    lblShowMoveNumInVariationPane =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblShowMoveNumInVariationPane")); // ("鍒嗘敮闈㈡澘涓婃樉绀烘墜鏁�"); //
    // $NON-NLS-1$
    ...
    JLabel lblKifuLoadLast =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblKifuLoadLast")); // ("鍔犺浇妫嬭氨鍚庤烦杞埌鏈�鍚�"); // $NON-NLS-1$
    ...
    lblLoadEstimate =
        new JLabel(
            resourceBundle.getString(
                "LizzieConfig.lblLoadEstimate")); // ("棰勫姞杞藉舰寮忓垽鏂紩鎿�"); // $NON-NLS-1$
    ...
    JLabel lblEstimateEngine =
        new JLabel(resourceBundle.getString("LizzieConfig.lblEstimateEngine")); // ("褰㈠娍鍒ゆ柇寮曟搸");
    ...
    JLabel SpecialCoords =
        new JLabel(resourceBundle.getString("ConfigDialog2.SpecialCoords")); // "鐗规畩鍧愭爣");
    ...
    JLabel lblShowMoveRank =
        new JLabel(resourceBundle.getString("LizzieConfig.lblShowMoveRank")); // "钀藉瓙璇勪环鏍囪"
    lblShowMoveRank.setBounds(10, 156, 130, 15);
    uiTab.add(lblShowMoveRank);

    JLabel lblNextMoveHint =
        new JLabel(resourceBundle.getString("LizzieConfig.lblNextMoveHint")); // ("涓嬩竴鎵嬫彁绀�");
    ...
    JLabel lblLogGtpToFile =
        new JLabel(resourceBundle.getString("LizzieConfig.lblLogGtpToFile")); // ("璁板綍GTP鏃ュ織鍒版枃浠�");
    ...
    JLabel lblLogConsoleToFile =
        new JLabel(
            resourceBundle.getString("LizzieConfig.lblLogConsoleToFile")); // ("璁板綍鎺у埗鍙版棩蹇楀埌鏂囦欢");
    ...
    comboMoveHint.addItem(resourceBundle.getString("LizzieConfig.comboMoveHint.none")); // ("鏃�");
    comboMoveHint.addItem(
        resourceBundle.getString("LizzieConfig.comboMoveHint.circle")); // ("鏄剧ず鍦�");
    comboMoveHint.addItem(
        resourceBundle.getString("LizzieConfig.comboMoveHint.winrate")); // ("鏄剧ず鑳滅巼");
  ...
  private void loadThemeTab() {
    ...
    cmbFontName.addItemListener(
        new ItemListener() {
          public void itemStateChanged(ItemEvent e) {
            ...
            if (fontName.equals("Lizzie榛樿") || fontName.equals("Lizzie Default"))
    ...
    // JLabel lblVarPanelTitile = new JLabel("鍒嗘敮闈㈡澘鑳屾櫙");
    ...
    JLabel labelBestMoveColor =
        new JLabel(resourceBundle.getString("ConfigDialog2.lblBestMoveColor")); // ("绗竴閫夌偣棰滆壊");
    ...
    JLabel lblBackgroundFilter =
        new JLabel(
            resourceBundle.getString("ConfigDialog2.lblBackgroundFilter")); // ("闈㈡澘鑳屾櫙妯＄硦绋嬪害");
    ...
    //      JButton applyBackgroundFilter = new JButton("搴旂敤");
  ...
  private class FontComboBoxRenderer<E> extends JLabel implements ListCellRenderer<E> {
    ...
    public Component getListCellRendererComponent(
      ...
      setText(fontName);
      if (fontName != null && (fontName.equals("Lizzie榛樿") || fontName.equals("Lizzie Default")))
  ...
  private void writeThemeValues() {
    if (cmbThemes.getSelectedIndex() <= 0) {
      ...
      if (themeName == null || themeName.isEmpty()) {
        ...
        if (theme.fontName().equals("Lizzie榛樿") || theme.fontName().equals("Lizzie Default")) {
          Lizzie.config.fontName = "SansSerif";
        } else if (theme.fontName() != null) {
          Lizzie.config.fontName = theme.fontName();
        }

        if (theme.uiFontName().equals("Lizzie榛樿") || theme.uiFontName().equals("Lizzie Default")) {
          if (Lizzie.config.isChinese)
        ...
        if (theme.winrateFontName().equals("Lizzie榛樿")
  ...
  private void writeDefaultTheme() {
    ...
    if (!Lizzie.config.uiConfig.optString("font-name").isEmpty()) {
      if (Lizzie.config.uiConfig.getString("font-name").equals("Lizzie榛樿")
    ...
    if (!Lizzie.config.uiConfig.optString("ui-font-name").isEmpty()
        && (Lizzie.config.uiConfig.getString("ui-font-name").equals("Lizzie榛樿")
    ...
    if (!Lizzie.config.uiConfig.optString("winrate-font-name").isEmpty()
        && (Lizzie.config.uiConfig.getString("winrate-font-name").equals("Lizzie榛樿")
